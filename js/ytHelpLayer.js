let ytHelpLayer = (function () {
	function ytHelpLayer () {
		...
		let helpBmp = new LBitmap(dataList["help"]);
		helpBmp.y = 20;
	...
	ytHelpLayer.prototype.addBtn = function () {
		...
		let okTxt = new LTextField();
		okTxt.color = "white";
		okTxt.size = 20;
		okTxt.text = "Ok, I know~";
		okTxt.weight = "bold";
		let okBtn = new ytButton(2, [okTxt, "center", "middle"], [0.6, 0.6]);
